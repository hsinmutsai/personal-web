---
layout: default
title: 2026 Spring - CSIE4004 Computer Science and Information Technology (II)
---
...
- Thu Mar. 5 - Course web page created.
...
<!-- 2026 Spring Register Policy -->

If you were not able to register for the course, please use this [form link](https://docs.google.com/forms/d/e/1FAIpQLSe4qpQqCB_WjRk2t78OWpG5pvO_hPKlDZrUvzSOLS5nkXbCtw/viewform?usp=dialog) to apply for course registration or auditing. 
This year, we will provide the registration codes <!--directly via email--> based on the order of form submissions until the classroom capacity is reached. We will process this before our first class on Friday, March 6. Therefore, we highly encourage you to complete the form as soon as possible.
...
|   16   | 06/12 |  No Class; Final Exam Week |             |
